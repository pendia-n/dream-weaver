...
// ═══════════════════════════════════
function renderAuth() {
  app.innerHTML = '<div class="auth-container"><div class="auth-box"><div class="auth-logo"><img src="/dreamstorydaynight.svg" alt="Dreamweaver" width="64" height="64" /></div><h1>Dreamweaver</h1><p class="tagline">Interpret your dreams with AI through the lenses of history\'s great minds</p><div class="auth-tabs"><button class="auth-tab active" id="tab-login">Login</button><button class="auth-tab" id="tab-register">Register</button></div><div id="auth-form"></div><div id="auth-links" style="margin-top:12px"></div></div></div>';
...
function renderForgotPassword() {
  app.innerHTML = '<div class="auth-container"><div class="auth-box"><h1><img src="/dreamstorydaynight.svg" alt="Dreamweaver" width="32" height="32" style="vertical-align:middle;margin-right:8px" /> Dreamweaver</h1><p class="tagline">Reset Password</p><p style="color:var(--text-dim);font-size:0.85em;margin-bottom:16px">Enter your username and TOTP code.</p><div id="auth-form"></div><div id="auth-links" style="margin-top:12px"><a href="#" id="back-login" style="color:var(--text-dim);font-size:0.85em">← Back to Login</a></div></div></div>';
...
function renderResetPassword(resetToken: string) {
  app.innerHTML = '<div class="auth-container"><div class="auth-box"><h1><img src="/dreamstorydaynight.svg" alt="Dreamweaver" width="32" height="32" style="vertical-align:middle;margin-right:8px" /> Dreamweaver</h1><p class="tagline">Set New Password</p><p style="color:#27ae60;font-size:0.85em;margin-bottom:16px">✓ Identity verified.</p><div id="auth-form"></div><div id="auth-links" style="margin-top:12px"><a href="#" id="back-login" style="color:var(--text-dim);font-size:0.85em">← Back to Login</a></div></div></div>';
  document.getElementById('back-login')!.onclick = (e) => { e.preventDefault(); authMode = 'login'; renderAuth(); };
  const form = document.getElementById('auth-form')!;
